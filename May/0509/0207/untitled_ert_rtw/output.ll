...
$"??_C@_0O@OOENIDN@Output?5z?3?5?$CFf?6?$AA@" = comdat any

$"??_C@_0O@FKNFAKJE@Output?5b?3?5?$CFf?6?$AA@" = comdat any

@k = dso_local constant double 2.000000e+00, align 8
@rtM_ = internal global %struct.tag_RTM zeroinitializer, align 8
@rtM = dso_local constant ptr @rtM_, align 8
...
@"??_C@_0O@OOENIDN@Output?5z?3?5?$CFf?6?$AA@" = linkonce_odr dso_local unnamed_addr constant [14 x i8] c"Output z: %f\0A\00", comdat, align 1
@"??_C@_0O@FKNFAKJE@Output?5b?3?5?$CFf?6?$AA@" = linkonce_odr dso_local unnamed_addr constant [14 x i8] c"Output b: %f\0A\00", comdat, align 1
@__local_stdio_printf_options._OptionsStorage = internal global i64 0, align 8

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @untitled_step() #0 {
  %1 = load double, ptr @x, align 8
  %2 = load double, ptr @y, align 8
  %3 = fadd double %1, %2
  %4 = load volatile double, ptr @k, align 8
  %5 = fmul double %3, %4
  store double %5, ptr @z, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @untitled_initialize() #0 {
...
6:                                                ; preds = %3
  call void @untitled_step()
  %7 = load double, ptr @z, align 8
  %8 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0O@OOENIDN@Output?5z?3?5?$CFf?6?$AA@", double noundef %7)
  %9 = load double, ptr @b, align 8
  %10 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0O@FKNFAKJE@Output?5b?3?5?$CFf?6?$AA@", double noundef %9)
  br label %11
